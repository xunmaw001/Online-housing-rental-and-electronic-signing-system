...
public class ZuhuController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		ZuhuEntity user = zuhuService.selectOne(new EntityWrapper<ZuhuEntity>().eq("zuhuzhanghao", username));
    ...
    public R register(@RequestBody ZuhuEntity zuhu){
    	...
    	ZuhuEntity user = zuhuService.selectOne(new EntityWrapper<ZuhuEntity>().eq("zuhuzhanghao", zuhu.getZuhuzhanghao()));
		if(user!=null) {
