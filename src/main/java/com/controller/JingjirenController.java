...
public class JingjirenController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		JingjirenEntity user = jingjirenService.selectOne(new EntityWrapper<JingjirenEntity>().eq("zhanghao", username));
    ...
    public R register(@RequestBody JingjirenEntity jingjiren){
    	...
    	JingjirenEntity user = jingjirenService.selectOne(new EntityWrapper<JingjirenEntity>().eq("zhanghao", jingjiren.getZhanghao()));
		if(user!=null) {
