<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="合同文件" prop="hetongwenjian">
          <el-input v-model="ruleForm.hetongwenjian" 
              placeholder="合同文件" clearable  :readonly="ro.hetongwenjian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="合同文件" prop="hetongwenjian">
              <el-input v-model="ruleForm.hetongwenjian" 
                placeholder="合同文件" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `hetongwenjian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.hetongwenjianCrossAddOrUpdateFlag = false;
                  this.parent.search();
