<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="房子户型" prop="fangzihuxing">
          <el-select v-model="ruleForm.fangzihuxing" placeholder="请选择房子户型">
            <el-option
                v-for="(item,index) in fangzihuxingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="成交时间" prop="chengjiaoshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.chengjiaoshijian" 
                type="date"
                placeholder="成交时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chengjiaoshijian" label="成交时间" prop="chengjiaoshijian">
              <el-input v-model="ruleForm.chengjiaoshijian" 
                placeholder="成交时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="成交价" prop="chengjiaojia">
          <el-input v-model="ruleForm.chengjiaojia" 
              placeholder="成交价" clearable  :readonly="ro.chengjiaojia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="成交价" prop="chengjiaojia">
              <el-input v-model="ruleForm.chengjiaojia" 
                placeholder="成交价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="合同文件" prop="hetongwenjian">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.hetongwenjian" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.hetongwenjian" label="合同文件" prop="hetongwenjian">
                    <span v-html="ruleForm.hetongwenjian"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.hetongwenjian = true;
          ...
          if(o=='chengjiaoshijian'){
            this.ruleForm.chengjiaoshijian = obj[o];
	    this.ro.chengjiaoshijian = true;
            continue;
          }
          if(o=='fangyuantupian'){
	    ...
	    this.ro.fangyuantupian = true;
          ...
          if(o=='chengjiaojia'){
            this.ruleForm.chengjiaojia = obj[o];
	    this.ro.chengjiaojia = true;
            continue;
          }
          if(o=='fabushijian'){
		...
		if(json.shouji!=''&&json.shouji){
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                this.fangzihuxingOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
	...
	this.ruleForm.fangyuanjieshao = this.ruleForm.fangyuanjieshao.replace(reg,'../../../ssm93614/upload');
	this.ruleForm.hetongwenjian = this.ruleForm.hetongwenjian.replace(reg,'../../../ssm93614/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
